...
def get_parser():
    ...
    parser.add_argument('--absolutePlot', default=True, type=ast.literal_eval,
                        help="=True:no shifted plotting of trajectory fragments")
    parser.add_argument('--neigPlot', default=True, type=ast.literal_eval,
                        help="=True:plot neigs vehicles in frame 1 of batch")
    parser.add_argument('--wandb_log', default=True, type=ast.literal_eval,
                        help="=True: log and use wandb.com to plot metrics and results")
