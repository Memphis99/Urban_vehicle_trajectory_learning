...
class STAR(torch.nn.Module):
    ...
    def forward(self, inputs, iftest=False):
        ...
        outputs = torch.zeros(nodes_abs.shape[0], num_Ped, 2).cuda()
        GM = torch.zeros(nodes_abs.shape[0], num_Ped, 32).cuda()
        ...
        for framenum in range(self.args.seq_length - 1):
            ...
            if framenum >= self.args.obs_length and iftest:
                ...
                nodes_current = torch.cat((nodes_abs[:self.args.obs_length, node_index], nodes_current))
